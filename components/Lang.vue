<template>
    <div class="lang  pointer-event" >
        <div class="img-box"     @click.prevent="setDirection()">
            {{ $i18n.localeProperties.name }}
            <!-- <img :src="" alt=""> -->
        </div>
        <div class="drop-down-box box-shadow p-2 " :class="$i18n.locale === 'fa' ? 'dir-rtl' : 'dir-ltr'" v-if="langBox"  @mouseout="!langBox" @mouseleave="!langBox">
