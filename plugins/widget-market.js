(() => {
  ...
  (() => {
    ...
    const a = "__FAIL__", l = "__NHTTP__", c = new RegExp("^http(s)?:(//)?");
    ...
    new class extends class {
      ...
      filterRawSettings(t) {
        const e = {}, i = Object.keys(t), r = new Set(this.propertiesToWorkWith);
        return i.forEach((i => {
          r.has(i) && (e[i] = t[i])
        })), e
      }
      ...
      _replaceScript(e) {
        const {scriptEnv: i, scriptURL: o, scriptElement: n, rawSettings: a, id: l} = e, c = n.parentNode,
          h = n.nonce || n.getAttribute("nonce"), d = function (t) {
            if (null === t) return null;
            const e = t.querySelector("#tradingview-copyright"), i = t.querySelector("#tradingview-quotes"), r = e || i;
            return r && t.removeChild(r), r
          }(c), g = c.querySelector(".tradingview-widget-copyright");
        this._copyrightContainer = d || g;
        const u = c.classList.contains("tradingview-widget-container");
        this.iframeContainer = c && u ? c : document.createElement("div"), a && (this.settings = this.filterRawSettings(a)), a && this._validateSettings() || (console.error("Invalid settings provided, fall back to defaults"), this.settings = this.filterRawSettings(this.defaultSettings));
        const m = "32px", {width: p, height: f} = this.settings,
          w = void 0 === f ? void 0 : `${f}${Number.isInteger(f) ? "px" : ""}`,
          y = void 0 === p ? void 0 : `${p}${Number.isInteger(p) ? "px" : ""}`;
        void 0 !== y && (this.iframeContainer.style.width = y), void 0 !== w && (this.iframeContainer.style.height = w);
        const b = function () {
        ...
        const v = this.hasCopyright() ? "calc(100% - 32px)" : "100%", S = location.hostname,
          C = g ? "widget_new" : "widget", _ = this.widgetUtmName();
        this.settings.utm_source = S, this.settings.utm_medium = C, this.settings.utm_campaign = _, this._updateCopyrightHrefParams(S, C, _);
        const T = this.settings.iframeTitle || `${this.widgetId.replace("-", " ")} TradingView widget`,
          k = this.settings.iframeLang || "en";
        this.iframe = this._createIframe(v, o, i, l, T, k);
        const L = this._iframeSrcHost(o, i);
        this._addCSPErrorListener(L), h && this.iframe.setAttribute("nonce", h);
        const A = this.iframeContainer.querySelector(".tradingview-widget-container__widget");
        if (A ? ((0, t.ensureNotNull)(A.parentElement).replaceChild(this.iframe, A), null == n || n.remove()) : u ? (this.iframeContainer.appendChild(this.iframe), null == n || n.remove()) : (this.iframeContainer.appendChild(this.iframe), c.replaceChild(this.iframeContainer, (0, t.ensureNotNull)(n))), this.shouldListenToIframeResize && function (t, e, i) {
          ...
          t.style.height = m, t.style.lineHeight = m, void 0 !== y && (t.style.width = y), t.style.textAlign = "center", t.style.verticalAlign = "middle", t.innerHTML = d.innerHTML, this.iframeContainer.appendChild(t)
        }
      }
      ...
      _iframeSrcHost(t, e) {
        ...
        const r = t.host.includes("beta.tradingview.com") || t.host.includes("betacdn.tradingview.com");
        return "staging" === e && r ? "https://www.xstaging-widget.tv" : ["staging", "local"].includes(e) ? `${t.protocol}//${t.host}` : i
      }
      ...
      _setSettingsQueryString(t) {
        const e = this.propertiesToAddToGetParams.filter((t => -1 !== d.indexOf(t))), i = function (t, e) {
      ...
      _createIframe(t, e, i, r, o, n) {
        const s = document.createElement("iframe");
        r && (s.id = r), this.settings.enableScrolling || s.setAttribute("scrolling", "no"), s.setAttribute("allowtransparency", "true"), s.setAttribute("frameborder", "0"), s.style.userSelect = "none", s.style.boxSizing = "border-box", s.style.display = "block", s.style.height = t, s.style.width = "100%";
        const a = new URL(this._iframeSrcBase(e, i));
        return this._setSettingsQueryString(a), this._setHashString(a, r), s.setAttribute("src", a.toString()), s.title = o, s.lang = n, s
      }
